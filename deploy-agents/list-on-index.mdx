...
<Note>
**Publishing from agent-template**: If you built an agent using [agent-template](https://github.com/agentsystems/agent-template), copy your files to create the index structure:
- Copy `agent.yaml` from your agent → `developers/your-username/agents/your-agent/agent.yaml`
- Copy `metadata.yaml` from your agent → `developers/your-username/agents/your-agent/0.1.0.yaml` (rename to match version)
- Create `versions.yaml` with `latest_version: "0.1.0"` and `listed_versions: ["0.1.0"]`
</Note>
