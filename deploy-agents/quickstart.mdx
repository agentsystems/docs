...
<Warning>
Making your Docker repository public means **anyone can pull and run your agent**. Your agent image will be publicly accessible on Docker Hub.
</Warning>

1. Go to [hub.docker.com](https://hub.docker.com)
2. Open your repository: `your-org/demo-agent`
3. Click **Settings** → **Visibility settings** → Change to **Public** → **Save**
