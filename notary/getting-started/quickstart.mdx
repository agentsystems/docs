...
## Using Arweave (Optional)

For decentralized hash storage on the Arweave blockchain, add `ArweaveHashStorage` to your hash storage list. Arweave requires a signer configuration for transaction signing.
...
Example using a local RSA-4096 private key:
...
See [Independent Verification](/notary/verification/arweave) for verifying Arweave-notarized logs.
