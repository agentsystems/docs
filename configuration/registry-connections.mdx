...
<Info>
Public registries typically work without credentials; some images may require authentication or be rate-limited. Private registries require authentication configured in [credentials](/configuration/credentials).
</Info>
